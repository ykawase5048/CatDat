...
(
	...
	'locally small',
	TRUE,
	'There is a forgetful functor $\Set_{\neq \varnothing} \to \Set$ and $\Set$ is locally small.'
),
(
	'Setne',
	'generator',
...
(
	...
	'cartesian closed',
	TRUE,
	'This follows as for $\Set$, since for non-empty sets $X,Y$ there is at least one function $X \to Y$.'
),
(
	'Setne',
	'mono-regular',
	TRUE,
	'This follows as for $\Set$.'
),
(
	'Setne',
	'epi-regular',
