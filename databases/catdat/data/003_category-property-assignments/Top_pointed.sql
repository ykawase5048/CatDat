...
(
	...
	FALSE,
	'Suppose that $\Top_*$ had effective congruences. Then by <a href="/lemma/coslice-effective-congruences">this result</a>, $\Top$ would also have effective congruences, which we know is not the case (see <a href="/category/Top">here</a>).'
),
(
	'Top*',
